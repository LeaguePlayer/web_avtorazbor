<?php
/**
 * Миграция m140328_101016_RequestLogs
 *
 * @property string $prefix
 */
 
class m140328_101016_RequestLogs extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{RequestLogs}}');
 
    public function safeUp()
    {
        $this->_checkTables();
 
        $this->createTable('{{RequestLogs}}', array(
