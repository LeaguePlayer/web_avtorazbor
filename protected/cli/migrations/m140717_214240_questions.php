<?php
/**
 * Миграция m140717_214240_questions
 *
 * @property string $prefix
 */
 
class m140717_214240_questions extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{questions}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{questions}}', array(
            ...
            'question' => "string COMMENT 'Ваш вопрос'",
            'theme' => "text COMMENT 'Тема письма'",
