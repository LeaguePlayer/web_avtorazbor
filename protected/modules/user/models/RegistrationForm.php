...
class RegistrationForm extends User {
	...
	public function rules() {
		$rules = array(
			array('username, password, verifyPassword, email, tel,fio,city', 'required'),
			array('email','match','pattern'=>'/[0-9a-z_]+@[-0-9a-z_^\.]+\.[a-z]{2,3}/i','message'=>'Введенный адрес не является адресмо электронной почты!'),
			array('username', 'length', 'max'=>20, 'min' => 4,'message' => UserModule::t("Длина логина должна занимать от 4 до 20 символов")),
			array('password', 'length', 'max'=>128, 'min' => 4,'message' => UserModule::t("Длина логина должна занимать от 4 до 128 символов")),
			array('email', 'email'),
