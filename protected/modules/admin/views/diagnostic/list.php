...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
    ...
    'afterAjaxUpdate'=>"function() {sortGrid('diagnostic')}",
...
<?php if($model->hasAttribute('sort')) Yii::app()->clientScript->registerScript('sortGrid', 'sortGrid("diagnostic");', CClientScript::POS_END) ;?>