<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php $tabs = array(); ?>
	<?php $tabs[] = array('label' => 'Основные данные', 'content' => $this->renderPartial('step3/_rows', array('form'=>$form, 'model' => $model), true), 'active' => true); ?>
	...
	<div class="form-actions">
        ...
        <?php echo TbHtml::submitButton('Оплачен', array('color' => TbHtml::BUTTON_COLOR_SUCCESS, 'class' => 'pull-right'))?>
	</div>
